...
const SlideGenerationPage = () => {
  ...
  useEffect(() => {
    return () => {
      // Don't clear on unmount, keep for refresh functionality
      // clearLocalStorage();
    };
  }, [documentId]);
  ...
  const handleEditClick = (slide) => {
    ...
    const slideContent = slide.bullets || slide.points || [];
